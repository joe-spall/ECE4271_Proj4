...
Installation
	...
	2. When inside the "code" directory of the project, run the following command in the terminal:
...
Use
	...
	1. After library installation and navigating to inside the "code" directory, run the program by using the following in the terminal:
